...
if socket.gethostname()=="amaechimcmillan":
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'travelapp/build')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = "travel:sign-in"
LOGIN_REDIRECT_URL = "travel:account"
LOGOUT_REDIRECT_URL = "travel:sign-in"
